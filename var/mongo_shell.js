...
db.pages.update({ path: { $neq: 'index' }}, { $set: { keywords: '', description: '' }}, { multi: true });
...
db.pages.update({ path: 'pricing' }, { $push: { content_blocks: { name: 'main-bottom', type: 'markdown', content: 'xxxxx', _id: (new ObjectId) }}});
